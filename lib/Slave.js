...
class Slave extends EventEmitter {
  ...
  constructor(file, opts) {
    ...
    args.push(`--dist-io-slave-id=${this[settings].id}`, `--dist-io-slave-alias=${this[settings].alias}`);
   ...
   */
  ack(meta) {
    return this.exec(Commands.ACK, typeof meta === 'object' && meta ? meta : { timeout: 3000 });
  }
   ...
   */
  noop(meta) {
    return this.exec(Commands.NULL, typeof meta === 'object' && meta ? meta : { timeout: 3000 });
  }
